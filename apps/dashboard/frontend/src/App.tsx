...
/**
 * Top-level router. No client-side routing library — the SPA shell is served
 * for every path, so we branch on the initial pathname.
 * - /tv: read-only glanceable board for a wall-mounted TV.
 * - everything else: the interactive home dashboard.
 */
 ...
 * - dash (iPad Mini landscape): wide left stack (lights side-by-side, finance
 *   horizontal underneath) + narrower Apps column on the right. Fits one frame.
 */
